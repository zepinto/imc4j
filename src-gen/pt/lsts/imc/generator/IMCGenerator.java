...
public class IMCGenerator {
	...
	private static final String pkgMsgs = "pt.lsts.imc.msg";
	private static final String pkgDefs = "pt.lsts.imc.def";
	...
	static FieldSpec parseField(String abbrev, FieldType ftype, String value) {
		...
		Builder anBuilder = AnnotationSpec.builder(pt.lsts.imc.annotations.FieldType.class);
