...
(:functions (distance ?l1 ?l2 - location)
            ...
            (time-elapsed ?v - vehicle) ; how long the vehicle is "operating"
            (goal-time ?v - vehicle) ; maximum time for the vehicle to arrive in the goal location
            (tasks-completed)
...
:condition (and (at start (at ?v ?l1))
                ...
                (over all (at_oi ?o ?l2))
                (over all (not (= ?l1 ?l2)))
                (over all (<= (time-elapsed ?v)(goal-time ?v)))
                ;(at start (< (+ (time-elapsed ?v)(/ (distance ?l1 ?l2)(speed ?v))) (goal-time ?v)))
...
:effect (and (at start (not (at ?v ?l1)))
             ...
             (at start (increase (time-elapsed ?v)(/ (distance ?l1 ?l2)(speed ?v))))
...
:effect (and (at start (not (at ?v ?l1)))
             ...
             (at end (not (can-move ?v)))
             (at start (increase (time-elapsed ?v)(/ (distance ?l1 ?l2)(speed ?v))))
             ;(at start (increase (base-returns) (* 10 (- (goal-time ?v)(+ (time-elapsed ?v)(/ (distance ?l1 ?l2)(speed ?v)))))))
             ;(at start (increase (base-returns) 1000))
             ;(at end (assign (time-elapsed ?v) 0))
             ;(at start (decrease (battery-level ?v)(* (battery-consumption-move ?v)(distance ?l1 ?l2))))
        )
)
...
:condition (and (over all (at_oi ?o ?l))
                ...
                (over all (<= (time-elapsed ?v)(goal-time ?v)))
                ;(at start (< (+ (time-elapsed ?v) 60) (goal-time ?v)))
...
:effect (and (at end (sampled ?t ?v))
             ...
             (at start (increase (time-elapsed ?v) 60))
...
:condition (and (over all (entry ?a ?l1))
               ...
               ; (at end (free ?l2))
                ...
                (at start (not (completed ?t)))
                (over all (<= (time-elapsed ?v)(goal-time ?v)))
                ;(at start (< (+ (time-elapsed ?v)(/ (surveillance_distance ?a)(speed ?v))) (goal-time ?v)))
...
:effect (and (at end (sampled ?t ?v))
             ...
             (at end (increase (tasks-completed) 1))
             (at start (increase (time-elapsed ?v)(/ (surveillance_distance ?a)(speed ?v))))
