...
public class PddlParser {
	...
	public static String initialState(PddlPlan plan, int vehicle) {
		...
		String nickname = VehicleParams.vehicleNickname(vehicle);
		
		System.out.println("Generating initial state for "+nickname);
	...
	public static void main(String[] args) throws ParseException {
		...
		Message plan = FormatConversion.fromJson(json);
		
		
		PddlPlan pplan = PddlPlan.parse((TemporalPlan)plan);
		
		System.out.println(pplan.actions(27));
		//System.out.println(PddlParser.initialState(pplan, 27));
